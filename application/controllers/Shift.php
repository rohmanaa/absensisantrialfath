...
class Shift extends CI_Controller
{
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                ...
                'walikelas' => ucwords($this->input->post('walikelas', TRUE)),
                'ketkelas' => strtoupper($this->input->post('ketkelas', TRUE)),
            );
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                ...
                'ketkelas' => set_value('ketkelas', $row->ketkelas),
                'user' => $user, 'users'     => $this->ion_auth->user()->row(),
                'users'     => $this->ion_auth->user()->row(),
            );
            $this->template->load('template/template', 'shift/shift_form', $data);
    ...
    public function update_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                'nama_shift' => strtoupper($this->input->post('nama_shift', TRUE)),
                'walikelas' => ucwords($this->input->post('walikelas', TRUE)),
                'ketkelas' => ucwords($this->input->post('ketkelas', TRUE)),
            );
    ...
    public function _rules()
    {
        ...
        $this->form_validation->set_rules('ketkelas', 'ketkelas', 'trim|required');
