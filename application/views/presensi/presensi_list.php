        ...
        <div class='col-xs-12'>
            <div class='box box-primary'>
                <div class='box-header  with-border'>
                    ...
                    <?php echo anchor(site_url('presensi/tidakabsen'),' <i class="fa fa-users"></i> &nbsp;&nbsp;Tidak Absen', ' class="btn btn-danger btn-lg btn-create-data btn3d"'); ?>
                        <?php echo anchor(site_url('presensi/create/'. $gedung->gedung_id), ' <i class="fa fa-plus"></i> &nbsp;&nbsp; Tambah Baru', ' class="btn btn-success btn-lg btn-create-data btn3d"'); ?>
                    </div>
                </div>
                <div class="box-body">
                </div><!-- /.box-header -->
                <div class='box-body'>
                    ...
                    <table id="presensi" class="table table-responsive table-bordered table-hover display" style="width:100%;">
                        <thead>
                            <tr>
                                <th class="all">No</th>
