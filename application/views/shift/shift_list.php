    ...
    <div class='row'>
        <div class='col-xs-12'>
            <div class='box box-primary'>
                ...
                <div class="box-body">
                    <table id="mytable" class="table table-responsive table-bordered table-hover display" style="width:100%;">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama kelas</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $shift->walikelas ?></td>
                                <td><?php echo $shift->ketkelas ?></td>
                                <td>
                                    <?php
