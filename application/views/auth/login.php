...
<style>
    ...
    .bg-br {
                background-image: url(<?php echo base_url() ?>assets/images/pr.svg);
...
<body class="hold-transition bg-br">

    <style media="screen">

    </style>

    <div class="login-box bg-br">
        ...
        <div class="login-box pt-5">
            ...
            <div class="login-box-body">
                <h3 class="text-center mt-0 mb-4">
                    <b>S</b>istem <b>A</b>administrasi <b>A</b>lfath
                </h3>
