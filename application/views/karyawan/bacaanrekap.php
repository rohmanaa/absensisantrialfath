        ...
        <div class='col-xs-12'>
            <div class='box box-success'>
                ...
                <?php $Karyawan = $this->Karyawan_model->get_by_id($segment = $this->uri->segment(3)); ?>
                   <h4 class='box-title'> TABEL DATA BACAAN : <span style="text-transform:uppercase ;color:green;"><b><?php echo $Karyawan->nama_karyawan ?></b></span></h3>
                </div><!-- /.box-header -->
                <div class='box-body'>
                    ...
                    <table id="mytable" class="table table-bordered table-hover display" style="width:100%;">
                        ...
                        <tbody>
                            ...
                            <tr><td><?php echo ++$start ?></td>
                                <td><?php echo $baca->tglbaca ?></td>
                                <td><?php echo $baca->ketbaca ?></td>
                                <td>  <?php
                                        echo anchor(site_url('bacaan/update/'. $baca->id_capai), '<i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;&nbsp;Edit', array('title' => 'edit', 'class' => 'btn btn-md btn-warning btn-edit-data btn3d'));
                                        ?></td>
