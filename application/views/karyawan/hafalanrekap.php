        ...
        <div class='col-xs-12'>
            <div class='box box-success'>
                ...
                <?php $Karyawan = $this->Karyawan_model->get_by_id($segment = $this->uri->segment(3)); ?>
                   <h4 class='box-title'> TABEL DATA HAFALAN : <span style="text-transform:uppercase ;color:green;"><b><?php echo $Karyawan->nama_karyawan ?></b></span></h3>
                </div><!-- /.box-header -->
                <div class='box-body'>
                <div class="actionSelect">
                    ...
                    <table id="mytable" class="table table-bordered table-hover display" style="width:100%;">
                        ...
                        <tbody>
                            ...
                            <td><?php echo $hf->tglhafal ?></td>
                                <td><?php echo $hf->bankhafalan ?></td>
                                <td><?php echo $hf->nilaihafal ?></td>
                                <td><?php echo $hf->kethafalan ?></td>
                                <td>  <?php
                                        echo anchor(site_url('hafalan/update/'. $hf->id_lapor), '<i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;&nbsp;Edit', array('title' => 'edit', 'class' => 'btn btn-md btn-warning btn-edit-data btn3d'));
                                        ?></td>
