                ...
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        <div class="form-group">
                            ...
                            <label for="nama_karyawan" class="control-label">Nama Santri</label>
                        ...
                        <div class="form-group">
                            <label for="jabatan" class="control-label">Tahun Masuk<?php echo form_error('jabatan') ?></label>
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            <label for="id_shift" class="control-label">Kelas<?php echo form_error('shift') ?></label>
                            <div class="input-group">
                        ...
                        <div class="form-group has-feedback">
                            <label for="statussantri"> Kategori <?php echo form_error('statussantri') ?></label>
                            <div class="input-group">
                            <select class="js-example-basic-single form-control" id="statussantri" style="width:100%" name="statussantri">
